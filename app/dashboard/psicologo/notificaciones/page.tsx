...
import { Bell, Clock, Users, CreditCard, AlertTriangle, CheckCircle, X } from "lucide-react"
import { AuthGuard } from "@/components/auth-guard"
import { Navigation } from "@/components/navigation"

export default function PsicologoNotificacionesPage() {
  const notificaciones = [
    {
      id: 1,
      tipo: "pago",
      titulo: "Pago pendiente",
      mensaje: "María González tiene un pago pendiente de $150",
      fecha: "Hace 2 horas",
      leida: false,
      urgencia: "alta",
      icono: CreditCard,
    },
    {
      ...
      mensaje: "Sesión con Carlos Rodríguez en 30 minutos",
      fecha: "Hace 30 min",
      leida: false,
      urgencia: "media",
      icono: Clock,
    },
    {
      ...
      mensaje: "Ana Martínez se ha registrado y solicita una cita",
      fecha: "Hace 1 hora",
      leida: true,
      urgencia: "baja",
      icono: Users,
    },
    {
      ...
      mensaje: "Se han actualizado las funcionalidades de video llamada",
      fecha: "Hace 3 horas",
      leida: true,
      urgencia: "baja",
      icono: CheckCircle,
    },
    {
      id: 5,
      tipo: "alerta",
      titulo: "Problema técnico resuelto",
      mensaje: "El problema de conectividad ha sido solucionado",
      fecha: "Ayer",
      leida: true,
      urgencia: "media",
      icono: AlertTriangle,
